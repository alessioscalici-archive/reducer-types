...
describe('when current state is TRUE', () => {
  ...
  it('applying TRUE should return TRUE', () => {
    let newState = actionReducer(oldState, { type: ACTION_TYPE_AND, payload: { value: true } });
    expect(newState).toBe(true);
  });

  it('applying FALSE should return FALSE', () => {
    let newState = actionReducer(oldState, { type: ACTION_TYPE_AND, payload: { value: false } });
